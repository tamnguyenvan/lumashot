...
from lumashot import config
from lumashot import transforms
from lumashot.utils import generate_video_path
...
class VideoRecordingThread:
    def __init__(self, output_path: str = None, start_delay: float = 0.5):
        ...
        self._fps = config.DEFAULT_FPS or 25
...
class ExportThread(QThread):
    ...
    def __init__(self, video_processor, export_params):
        ...
        self.output_dir = os.path.join(os.path.expanduser("~"), "Videos/LumaShot")
