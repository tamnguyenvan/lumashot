...
from lumashot import rc_main
from lumashot import rc_icons
from lumashot import rc_images
from lumashot.model import ClipTrackModel, WindowController, VideoController, VideoRecorder
from lumashot.image_provider import FrameImageProvider
...
def main():
    ...
    icon_path = base_path / "resources/icons/lumashot.ico"
